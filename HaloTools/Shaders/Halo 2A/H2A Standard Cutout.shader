// Upgrade NOTE: upgraded instancing buffer 'HaloToolsHalo2AnniversaryStandardCutout' to new syntax.

// Made with Amplify Shader Editor
// Available at the Unity Asset Store - http://u3d.as/y3X 
Shader "Halo Tools/Halo 2 Anniversary/Standard Cutout"
{
	Properties
	{
	...
	SubShader
	{
		...
		UNITY_INSTANCING_BUFFER_START(HaloToolsHalo2AnniversaryStandardCutout)
			UNITY_DEFINE_INSTANCED_PROP(float4, _ParallaxMap_ST)
#define _ParallaxMap_ST_arr HaloToolsHalo2AnniversaryStandardCutout
			UNITY_DEFINE_INSTANCED_PROP(float4, _BumpMap_ST)
#define _BumpMap_ST_arr HaloToolsHalo2AnniversaryStandardCutout
			UNITY_DEFINE_INSTANCED_PROP(float4, _DetailNormalMap_ST)
#define _DetailNormalMap_ST_arr HaloToolsHalo2AnniversaryStandardCutout
			UNITY_DEFINE_INSTANCED_PROP(float4, _MainTex_ST)
#define _MainTex_ST_arr HaloToolsHalo2AnniversaryStandardCutout
			UNITY_DEFINE_INSTANCED_PROP(float4, _DetailAlbedoMap_ST)
#define _DetailAlbedoMap_ST_arr HaloToolsHalo2AnniversaryStandardCutout
			UNITY_DEFINE_INSTANCED_PROP(float4, _EmissionMap_ST)
#define _EmissionMap_ST_arr HaloToolsHalo2AnniversaryStandardCutout
			UNITY_DEFINE_INSTANCED_PROP(float4, _EmissionColor)
#define _EmissionColor_arr HaloToolsHalo2AnniversaryStandardCutout
			UNITY_DEFINE_INSTANCED_PROP(float4, _FresnelColor)
#define _FresnelColor_arr HaloToolsHalo2AnniversaryStandardCutout
			UNITY_DEFINE_INSTANCED_PROP(float4, _SpecGlossMap_ST)
#define _SpecGlossMap_ST_arr HaloToolsHalo2AnniversaryStandardCutout
			UNITY_DEFINE_INSTANCED_PROP(float, _Parallax)
#define _Parallax_arr HaloToolsHalo2AnniversaryStandardCutout
			UNITY_DEFINE_INSTANCED_PROP(float, _BumpScale)
#define _BumpScale_arr HaloToolsHalo2AnniversaryStandardCutout
			UNITY_DEFINE_INSTANCED_PROP(float, _DetailNormalIntensity)
#define _DetailNormalIntensity_arr HaloToolsHalo2AnniversaryStandardCutout
			UNITY_DEFINE_INSTANCED_PROP(float, _EmissionIntensity)
#define _EmissionIntensity_arr HaloToolsHalo2AnniversaryStandardCutout
			UNITY_DEFINE_INSTANCED_PROP(float, _FresnelScale)
#define _FresnelScale_arr HaloToolsHalo2AnniversaryStandardCutout
			UNITY_DEFINE_INSTANCED_PROP(float, _FresnelPower)
#define _FresnelPower_arr HaloToolsHalo2AnniversaryStandardCutout
			UNITY_DEFINE_INSTANCED_PROP(float, _GlossMapScale)
#define _GlossMapScale_arr HaloToolsHalo2AnniversaryStandardCutout
		UNITY_INSTANCING_BUFFER_END(HaloToolsHalo2AnniversaryStandardCutout)
		...
		void surf( Input i , inout SurfaceOutputStandardSpecular o )
		{
			...
			float3 desaturateInitialColor44 = ( tex2DNode1 * tex2D( _DetailAlbedoMap, uv_DetailAlbedoMap ) ).rgb;
...
/*ASEBEGIN
Version=18800
330.6667;720;1280;659;996.48;-700.4161;1;True;False
...
Node;AmplifyShaderEditor.CommentaryNode;67;-1393.515,-816;Inherit;False;1161.517;704.6202;Albedo;4;58;44;1;6;;0.1153229,1,0,1;0;0
Node;AmplifyShaderEditor.RangedFloatNode;14;-1349.241,557.9021;Inherit;False;InstancedProperty;_FresnelPower;Fresnel Power;13;0;Create;True;0;0;0;False;0;False;3;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;3;-869.4906,432.6515;Inherit;True;Property;_EmissionMap;Emission;8;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;71;-592,544;Inherit;False;InstancedProperty;_EmissionIntensity;Emission Intensity;9;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;118;-576,752;Inherit;False;InstancedProperty;_EmissionColor;Emission Color;7;0;Create;False;0;0;0;False;0;False;1,1,1,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;11;-1232,-64;Inherit;False;InstancedProperty;_BumpScale;Normal Intensity;5;0;Create;False;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;69;-1280,176;Inherit;False;InstancedProperty;_DetailNormalIntensity;Detail Normal Intensity;12;0;Create;True;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;15;-1345.241,476.9019;Inherit;False;InstancedProperty;_FresnelScale;Fresnel Scale;14;0;Create;True;0;0;0;False;0;False;0.015;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;1;-1286.624,-532.3815;Inherit;True;Property;_MainTex;Albedo;1;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;19;-1109.491,640.6516;Inherit;False;InstancedProperty;_FresnelColor;Fresnel Color;15;0;Create;True;0;0;0;False;0;False;0.8490566,0.8490566,0.8490566,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;6;-1286.624,-340.3815;Inherit;True;Property;_DetailAlbedoMap;Detail Albedo;10;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;2;-1048.146,-64.42409;Inherit;True;Property;_BumpMap;Normal;4;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;53;-1056,128;Inherit;True;Property;_DetailNormalMap;Detail Normal;11;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ToggleSwitchNode;130;-251.2731,532.6979;Inherit;False;Property;_EMISSION;Toggle Emission;6;0;Create;False;0;0;0;False;0;False;0;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;92;-670.1091,-465.1528;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;123;-1071.493,985.4866;Inherit;False;InstancedProperty;_Parallax;Height Multiplier;17;0;Create;False;0;0;0;False;0;False;0;0;-0.25;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;121;-915.3577,1140.399;Inherit;True;Property;_ParallaxMap;Hdetm;16;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;black;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;4;-48,80;Inherit;False;InstancedProperty;_GlossMapScale;Smoothness;3;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.GetLocalVarNode;60;216,-84;Inherit;False;58;Albedo;1;0;OBJECT;;False;1;FLOAT3;0
Node;AmplifyShaderEditor.SamplerNode;78;-187,304.955;Inherit;True;Property;_SpecGlossMap;Specular;2;0;Create;False;0;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StandardSurfaceOutputNode;0;436.7308,-19.16853;Float;False;True;-1;2;ASEMaterialInspector;0;0;StandardSpecular;Halo Tools/Halo 2 Anniversary/Standard Cutout;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;False;Off;0;False;-1;0;False;-1;False;0;False;-1;0;False;-1;False;0;Custom;0.5;True;True;0;False;TransparentCutout;;Geometry;All;14;all;True;True;True;True;0;False;-1;False;0;False;-1;255;False;-1;255;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;-1;False;2;15;10;25;False;0.5;True;0;0;False;-1;0;False;-1;0;0;False;-1;0;False;-1;0;False;-1;0;False;-1;0;False;0;0,0,0,0;VertexOffset;True;False;Cylindrical;False;Relative;0;Standard (Specular setup);0;-1;-1;-1;0;False;0;0;False;-1;-1;0;False;-1;0;0;0;False;0.1;False;-1;0;False;-1;False;16;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;4;FLOAT;0;False;5;FLOAT;0;False;6;FLOAT3;0,0,0;False;7;FLOAT3;0,0,0;False;8;FLOAT;0;False;9;FLOAT;0;False;10;FLOAT;0;False;13;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;12;FLOAT3;0,0,0;False;14;FLOAT4;0,0,0,0;False;15;FLOAT3;0,0,0;False;0
...
ASEEND*/
//CHKSM=394043796B61D451A7E255D1D82D340E6C55BAA9